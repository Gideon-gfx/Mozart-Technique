...
import type { OrgStudentMoreStackParamList } from '../../navigation/types';
import type { ThemeOverride } from '../../theme/ThemeContext';
import type { ThemeColors } from '../../theme/colors';
import { fonts } from '../../theme/fonts';
import { useTheme } from '../../theme/useTheme';

type Props = NativeStackScreenProps<OrgStudentMoreStackParamList, 'OrgStudentMoreHome'>;
...
// Org Student mode's own lean More menu - "Switch to Student" is the one
// way back, same as Tutor/Sponsor's, since this mode is reached from
// Profile regardless of which mode you were in before.
export default function OrgStudentMoreScreen({ navigation }: Props) {
    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      <View style={styles.profileRow}>
        ...
        <View style={styles.profileInfo}>
          ...
          <Text style={styles.role}>Organization Student</Text>
        </View>
      </View>
      ...
      <Pressable style={styles.switchCard} onPress={switchToStudent}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.switchSubtitle}>Back to your regular student dashboard</Text>
        </View>
