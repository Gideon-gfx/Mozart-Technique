...
import type { OrgNotification } from '../../api/organizations';
...
type Props = NativeStackScreenProps<MainStackParamList, 'OrgNotifications'>;
...
// Org Tutor's own notification bell - only things related to this
// organization (membership/application updates, content posts, events),
// unlike the generic Notifications screen which shows the account's whole
// history. Sourced from the same /api/organizations/tutor-workspace call
// the rest of Org Tutor mode uses, which now filters user.notifications
// down to org-related ones server-side.
export default function OrgNotificationsScreen({ navigation }: Props) {
  ...
  return (
    <View style={styles.screen}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Organization Notifications</Text>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.centered}>
              <Text style={styles.emptyText}>Nothing from your organization yet.</Text>
            </View>
          }
          renderItem={({ item }) => (
