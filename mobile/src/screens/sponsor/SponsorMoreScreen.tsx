...
import type { SponsorMoreStackParamList } from '../../navigation/types';
import type { ThemeOverride } from '../../theme/ThemeContext';
import type { ThemeColors } from '../../theme/colors';
import { fonts } from '../../theme/fonts';
import { useTheme } from '../../theme/useTheme';

type Props = NativeStackScreenProps<SponsorMoreStackParamList, 'SponsorMoreHome'>;
...
// Sponsor mode's own lean More menu - "Switch to Student" is the one way
// back, same as Tutor mode's, since Sponsor is reached from Profile
// regardless of which mode you were in before.
export default function SponsorMoreScreen({ navigation }: Props) {
